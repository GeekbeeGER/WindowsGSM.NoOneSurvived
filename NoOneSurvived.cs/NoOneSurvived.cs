...
{
    public class NoOneSurvived : SteamCMDAgent // SteamCMDAgent is used because GMOD relies on SteamCMD for installation and update process
    {
        // - Plugin Details
        public Plugin Plugin = new Plugin
        {
            ...
            author = "Geekbee",
            description = "🧩 WindowsGSM plugin for supporting Night of the Dead Dedicated Server",
            version = "1.0",
        ...
        public override string AppId => "2329680"; // Game server appId, GMOD is 4020


        // - Game server Fixed variables
        public override string StartPath => @"NoOneSurvivedServerStart.exe"; // Game server start path, for GMOD, it is srcds.exe
        public string FullName = "No One Survived Dedicated Server"; // Game server FullName
